	...
	return (
		...
		<View style={styles.containerInitial}>
          ...
          modalWithSafeAreaView={true}
					...
					itemFontFamily={{ fontFamily: 'Nasa' }}
					searchTextFontFamily={{ fontFamily: 'Nasa' }}
					selectText='Select Currency'
					searchIconComponent={() => <Icon name="search" color="#FFFFFF" size={20} style={{marginLeft: 10, marginRight: 10}} />}
					noResultsComponent={() => <Text style={{fontFamily: 'Nasa' ,color: '#FFFFFF' ,textAlign: 'center'}}>Sorry, no results.</Text>}
					colors={{ 
						text: '#FFFFFF',
						selectToggleTextColor: currency.length === 0 ? '#FF0000' : '#FFFFFF',
						itemBackground: '#1E1E1E',
						searchPlaceholderTextColor: '#FFFFFF',
						searchSelectionColor: '#FF0000'
					}}
					styles={{
						container: { 
        ...
        <View style={{flexDirection: 'row', marginHorizontal: '5%', marginTop: '5%', justifyContent: 'space-between', width: '90%'}}>
            ...
            renderErrorMessage={false}
				...
				>
					<Text style={{fontFamily: 'Nasa', fontSize: RFValue(16.5), marginBottom: 10, color: '#FFFFFF'}}>Bro?</Text>
					<Text style={{fontFamily: 'Nasa', color: '#FFFFFF'}}>Stop being lazy and fill everything.</Text>
					<Dialog.Actions>
				...
				<Dialog
					...
					overlayStyle={{borderRadius: 10, backgroundColor: '#121212', borderWidth: 2, borderColor: '#77B6FF'}}
				>
					<Text style={{fontFamily: 'Nasa', fontSize: RFValue(16.5), marginBottom: 10, color: '#FFFFFF'}}>Loner Alert!</Text>
					<Text style={{fontFamily: 'Nasa', color: '#FFFFFF'}}>Add one more person.</Text>
					<Dialog.Actions>
				...
				<Dialog
					...
					overlayStyle={{borderRadius: 10, backgroundColor: '#121212', borderWidth: 2, borderColor: '#77B6FF'}}
				>
					<Text style={{fontFamily: 'Nasa', fontSize: RFValue(16.5), marginBottom: 10, color: '#FFFFFF'}}>Hmmmm</Text>
					<Text style={{fontFamily: 'Nasa', color: '#FFFFFF'}}>Repeating the same name doesn't mean multiple friends.</Text>
					<Dialog.Actions>
